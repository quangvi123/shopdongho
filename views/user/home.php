<main class="home">
    <article>
        ...
        <div class="title-danhmuc">
            <h2>Giới thiệu</h2>
            <div class="view">
                <img src="https://gshock.casio.com/content/casio/locales/th/th/brands/gshock/g-news/new-releases/_jcr_content/root/responsivegrid/container/content_panel_list_c/content_panel_202303/image.casiocoreimg.jpeg/1714562497241/thum.jpeg" alt="">
                <P>
                    Đồng hồ G-Shock là một trong những dòng sản phẩm nổi bật của Casio, được biết đến với khả năng chịu lực, chống va đập và chống nước vượt trội, phù hợp với những ai yêu thích hoạt động thể thao và mạo hiểm. Được thiết kế với phong cách mạnh mẽ, năng động, G-Shock không chỉ là một chiếc đồng hồ mà còn là người bạn đồng hành đáng tin cậy trong mọi tình huống.

                    Các mẫu đồng hồ G-Shock thường có tính năng đếm ngược, bấm giờ thể thao, lịch vạn niên, và đèn LED sáng, giúp người dùng dễ dàng theo dõi thời gian ngay cả trong môi trường thiếu sáng. Ngoài ra, một số phiên bản cao cấp còn được trang bị công nghệ Bluetooth kết nối với điện thoại, giúp theo dõi sức khỏe và cung cấp thông tin hữu ích.

                    Với sự kết hợp giữa độ bền vượt trội, thiết kế hiện đại và tính năng đa dạng, đồng hồ G-Shock là lựa chọn lý tưởng cho những ai yêu thích sự mạnh mẽ và khác biệt.
                </P>
            </div>
        </div>
...
<div class="product-list">
    <div class="product-item">
        <img src="https://gshock.casio.com/content/casio/locales/th/th/brands/gshock/g-news/new-releases/_jcr_content/root/responsivegrid/container/content_panel_list_c/content_panel_202303/image.casiocoreimg.jpeg/1714562497241/thum.jpeg" alt="Sản phẩm 1">
        <div class="product-info">
            <h3>G-Shock Series X</h3>
    ...
    <div class="product-item">
        <img src="https://gshock.casio.com/content/casio/locales/th/th/brands/gshock/g-news/new-releases/_jcr_content/root/responsivegrid/container/content_panel_list_c/content_panel_202303/image.casiocoreimg.jpeg/1714562497241/thum.jpeg" alt="Sản phẩm 2">
        <div class="product-info">
            <h3>G-Shock 2025 Edition</h3>
            <p class="product-price">3,800,000 VNĐ</p>
            <button class="buy-now">Mua ngay</button>
        </div>
    </div>
    <div class="product-item">
        <img src="https://gshock.casio.com/content/casio/locales/th/th/brands/gshock/g-news/new-releases/_jcr_content/root/responsivegrid/container/content_panel_list_c/content_panel_202303/image.casiocoreimg.jpeg/1714562497241/thum.jpeg" alt="Sản phẩm 3">
        <div class="product-info">
            <h3>G-Shock Classic Black</h3>
            <p class="product-price">3,200,000 VNĐ</p>
            <button class="buy-now">Mua ngay</button>
        </div>
    </div>
    <div class="product-item">
        <img src="https://gshock.casio.com/content/casio/locales/th/th/brands/gshock/g-news/new-releases/_jcr_content/root/responsivegrid/container/content_panel_list_c/content_panel_202303/image.casiocoreimg.jpeg/1714562497241/thum.jpeg" alt="Sản phẩm 4">
        <div class="product-info">
            <h3>G-Shock Digital Red</h3>
            <p class="product-price">3,000,000 VNĐ</p>
            <button class="buy-now">Mua ngay</button>
        </div>
    </div>
</div>
                ...
                <div id="models-selling" class="slider-models">
                    <div class="selling-model">
                        <div class="model-sl">
                            ...
                            <div class="name-model-sell">
                                <a href="">
                                    <h5>MULTICOLOR ACCENTS</h5>
                                </a>
                                <span>Monochromatic color schemes with a playful touch: Multicolor designs with a pop flair</span>
                            </div>
                        </div>
                    </div>
                    <div class="selling-model">
                    ...
                    <div class="selling-model">
                        <div class="model-sl">
                            ...
                            <div class="name-model-sell">
                                <a href="">
                                    <h5>TEAM LAND CRUISER TOYOTA AUTO BODY</h5>
                                </a>
                    ...
                    <div class="selling-model">
                        <div class="model-sl">
                            ...
                            <div class="name-model-sell">
                                <a href="">
                                    <h5>BEAUTIFULL PEOPLE x G-SHOCK</h5>
                                </a>
                    ...
                    <div class="selling-model">
                        <div class="model-sl">
                            ...
                            <div class="name-model-sell">
                                <a href="">
                                    <h5>CHARLES DARWIN FOUNDATION PARTNERSHIP MODEL</h5>
                                </a>
